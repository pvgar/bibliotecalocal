...
class Book(models.Model):
    ...
    idiom = models.ForeignKey('Idiom', on_delete=models.SET_NULL, null=True)
    # ForeignKey, ya que un libro tiene un solo idioma, pero el mismo idioma puede corresponder a muchos libros.
    # 'Author' es un string, en vez de un objeto, porque la clase Author aún no ha sido declarada.
...
class Idiom(models.Model):
    ...
    """
    idiom = models.CharField(max_length=200, help_text="Ingrese el nombre del idioma (p. ej. Ingles, Español etc.)")
